  ...
  describe '#update' do
    context 'when the user enters an invalid OTP' do
      ...
      it 'redirects to the OTP entry screen' do
        expect(response).to redirect_to(otp_confirm_path)
      end
  ...
  describe '#send_code' do
    context 'when selecting SMS OTP delivery' do
      ...
      it 'notifies the user of OTP transmission' do
        ...
        expect(flash[:success]).to eq t('devise.two_factor_authentication.send_code.sms')
      end
    end
    ...
    context 'when selecting voice OTP delivery' do
      ...
      it 'notifies the user of OTP transmission' do
        ...
        expect(flash[:success]).to eq t('devise.two_factor_authentication.send_code.voice')
      end
    end
  end
end
